...
static ALLERGENS_LEN: usize = ALLERGENS.len();

static DISHES: [&'static str; 54] = [
    "Arepas",
    "Barbecue Ribs",
...
static DISHES_LEN: usize = DISHES.len();

static DESCRIPTIONS: [&'static str; 14] = [
...
static DESCRIPTIONS_LEN: usize = DESCRIPTIONS.len();

static INGREDIENTS: [&'static str; 488] = [
    "Achacha",
    "Adzuki Beans",
    "Agar",
    "Agave Syrup",
...
static INGREDIENTS_LEN: usize = INGREDIENTS.len();

static FRUITS: [&'static str; 69] = [
    "Apples",
    "Apricots",
    "Aubergine",
    "Avocado",
...
static FRUITS_LEN: usize = FRUITS.len();

static VEGETABLES: [&'static str; 64] = [
    "Artichoke",
    "Arugula",
    "Asian Greens",
    "Asparagus",
...
static VEGETABLES_LEN: usize = VEGETABLES.len();

static SPICES: [&'static str; 183] = [
    "Achiote Seed",
    "Ajwain Seed",
    "Ajwan Seed",
    "Allspice Ground",
...
static SPICES_LEN: usize = SPICES.len();

static MEASUREMENTS: [&'static str; 6] = [
    "teaspoon",
    "tablespoon",
    "cup",
    "pint",
...
static MEASUREMENTS_LEN: usize = MEASUREMENTS.len();

static METRIC_MEASUREMENTS: [&'static str; 4] = [
    "milliliter",
    "deciliter",
    "centiliter",
    "liter",
];
static METRIC_MEASUREMENTS_LEN: usize = METRIC_MEASUREMENTS.len();

static MEASUREMENT_SIZES: [&'static str; 6] = [
    "1/4",
    "1/3",
    "1/2",
    "'1'",
...
static SUSHIS_LEN: usize = SUSHIS.len();

static ETHNIC_CATEGORIES: [&'static str; 118] = [
    "Ainu",
    "Albanian",
    "Argentine",
    "Andhra",
...
static ETHNIC_CATEGORIES_LEN: usize = ETHNIC_CATEGORIES.len();