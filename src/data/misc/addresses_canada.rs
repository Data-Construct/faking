...
pub fn full_address() -> String {
    ...
    match format{
        0=>format!("{}, {}, {} {}", street_address(), city, province, postal_code),
        1=>format!("{} {}, {}, {} {}", street_address(), secondary_address(), city, province, postal_code),
        _=>"".to_string()
    }
}
