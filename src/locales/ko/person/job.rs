// https://github.com/joke2k/faker/blob/master/faker/providers/job/ko_KR/__init__.py
// Reference:
// http://zetawiki.com/wiki/%ED%95%9C%EA%B5%AD%ED%91%9C%EC%A4%80%EC%A7%81%EC%97%85%EB%B6%84%EB%A5%98_%ED%91%9C
// on 2017-08-30
pub static KO__JOB: [&'static str; 425] = [
	"의회의원/고위공무원 및 공공단체임원",
	"기업고위임원",
	"정부행정 관리자",
	"경영지원 관리자",
...
pub static KO__JOB_LEN: usize = KO__JOB.len();
