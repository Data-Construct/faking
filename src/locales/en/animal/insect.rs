...
#[wasm_bindgen(js_name = animal_insect)]
pub fn insect() -> String {
	EN_INSECT[seeder::gen_range(0..EN_INSECT_LEN)].to_string()
}

static EN_INSECT: [&'static str; 129] = [
    "Acacia-ants",
    "Acorn-plum gall",
    "Aerial yellowjacket",
...
static EN_INSECT_LEN: usize = EN_INSECT.len();