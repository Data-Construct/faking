...
#[wasm_bindgen(js_name = animal_horse)]
pub fn horse() -> String {
	EN_HORSE[seeder::gen_range(0..EN_HORSE_LEN)].to_string()
}

static EN_HORSE: [&'static str; 345] = [
    "American Albino",
    "Abaco Barb",
    "Abtenauer",
    "Abyssinian",
...
static EN_HORSE_LEN: usize = EN_HORSE.len();