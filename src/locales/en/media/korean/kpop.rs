...
static GROUPS_FIRST_GEN_LEN: usize = GROUPS_FIRST_GEN.len();

static GROUPS_SECOND_GEN: [&'static str; 67] = [
  "CB Mass",
  "Papaya",
  "5tion",
  "Jewelry",
...
static GROUPS_SECOND_GEN_LEN: usize = GROUPS_SECOND_GEN.len();

static GROUPS_THIRD_GEN: [&'static str; 214] = [
  "APeace",
  "CNBLUE",
  "Coed School",
  "DMTN",
...
static GROUPS_THIRD_GEN_LEN: usize = GROUPS_THIRD_GEN.len();

static GIRL_GROUPS: [&'static str; 135] = [
  "2NB",
  "2NE1",
  "2Yoon",
  "4L",
...
static GIRL_GROUPS_LEN: usize = GIRL_GROUPS.len();

static BOY_BANDS: [&'static str; 167] = [
  "1TYM",
  "2AM",
  "2PM",
  "4Men",
...
static BOY_BANDS_LEN: usize = BOY_BANDS.len();

static SOLOISTS: [&'static str; 338] = [
  "Ailee",
  "Ajoo",
...
static SOLOISTS_LEN: usize = SOLOISTS.len();