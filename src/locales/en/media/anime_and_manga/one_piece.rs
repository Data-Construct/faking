...
static QUOTES: [&'static str; 99] = [
	...
	"Do not ever think there is any perfect society made by humans!! If you think that way youll overlook the enemy!! Do not be fooled by appearances!! - Smoker",
	...
	"Men who can not wipe away the tears from a womens eyes, arent real men. - Sanji Vinsmoke",
