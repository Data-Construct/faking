...
static QUOTES: [&'static str; 123] = [
	"Home is where youre surrounded by other critters that care about you.",
	...
	"Ill have you know that I stubbed by toe last week and only cried for 20 minutes.",
	"Its not always what you say that matters, sometimes its what you dont say.",
	"I know of a place where you never get harmed. A magical place with magical charm. Indoors. Indoors. Indoors!",
	"Good people dont rip other peoples arms off.",
	"Dumb people are always blissfully unaware of how dumb they really are…",
	"Youre a man now, SpongeBob, and its time you started acting like one.",
	...
	"This is not your average, everyday darkness. This is…ADVANCED darkness. Hey, if I close my eyes it doesnt seem so dark.",
	...
	"Run Mr. Krabs! Run like youre not in a coma!",
	...
	"If theres one thing we Atlanteans enjoy, its a healthy dose of dark humor!",
	"You dont need a license to drive a sandwich",
	"Holographic Meatloaf? My favorite!",
	"Oh well, I guess Im not wearing any pants today!",
	"We shall never deny a guest, even the most ridiculous request.",
	"Im so loyal, I dont mind sleeping out in the cold, hard ground while Captain Krabs sleeps in his warm, dry tent.",
	...
	"Im a good noodle!",
	"We dont need television…not as long as we have our imagination.",
	"Being grown up is boring. Besides, I dont get jazz.",
	"F is for friends who do stuff together!",
	"Is mayonnaise an instrument?",
	"Once upon a time there was an ugly barnacle. He was so ugly that everyone died. The end!",
	"I wumbo, you wumbo, he she we wumbo.",
	"Wake me up when I care.",
	"Its just a cruel reminder that Im single and likely to remain that way forever.",
	...
	"But its my only night to be fancy!",
	...
	"Who are you people?!",
	"Squidward thats not the peace treaty, thats a copy of the peace treaty.",
	"After going on your life-changing journey, you now realize that you dont want what you thought you wanted. What you really wanted was inside you all along.",
	"Karen, baby, I havent felt this giddy since the day you agreed to be my wife!",
	"Thats a big boot.",
	"Oh Karen, my computer wife, if only I could have managed to steal the secret to Krabs success. The formula for the Krabby Patty…Ohhh…Then people would line up to eat at MY restaurant! Lord knows Ive tried. Ive exhausted every evil plan in my filing cabinet…from A to Y!",
	"Patrick, youve been wearing the same Goofy Goober Peanut Party underpants for three years straight! What do you call that?",
	"Its evil. Its diabolical. Its lemon-scented. This Plan Z cant possibly fail!",
	"Pull your pants up, Patrick. Were going home.",
	...
	"His chops are too righteous. The helmets cant handle this level of rock n roll! Karen, do something!",
	...
	"I think dont ready go back to work Mr. Krabs.",
	"Listen here you crustacous cheapskate!",
	"Im taking jelly off the menu.",
	...
	"Just look at his daughter, shes as big as a whale!",
	"What? Its just an ordinary Krabby Patt - Oh my goodness! Squidward!",
	"You like Krabby Patties, dont you squidward?",
	"I have no soul!",
	"Next youll be asking me to go square dancing with Patrick!",
	"Because you and me - Were like brothers. Only closer.",
	"So much time later the narrator got tired so they hired a new narrator",
	"Two things that wont work!",
	"Oh no hes hot!",
