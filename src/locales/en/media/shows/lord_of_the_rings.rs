...
static QUOTES: [&'static str; 54] = [
  ...
  "I do not keep water in my pockets.",
  ...
  "It is the job thats never started as takes longest to finish.",
  "Moonlight drowns out all but the brightest stars.",
  "Fear nothing! Have peace until the morning! Heed no nightly noises!",
  "I will get there, if I leave everything but my bones behind,",
