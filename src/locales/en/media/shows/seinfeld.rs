...
static QUOTES: [&'static str; 55] = [
  ...
  "Shes one of those low-talkers. You can not hear a word she is saying!",
  ...
  "If you can not say something bad about a relationship, you should not say anything at all.",
  ...
  "Sex, that is meaningless, I can understand that, but dinner; that is heavy. That is like an hour.",
  ...
  "I do not trust the guy. I think he regifted, then he degifted, and now he is using an upstairs invite as a springboard to a Super bowl sex romp.",
