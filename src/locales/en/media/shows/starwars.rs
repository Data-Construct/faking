	...
	static ref CHARACTER_QUOTES_HASHMAP: HashMap<&'static str, Vec<String>> = {
		...
		m.insert(
			...
			vec![
				...
				"Lets just say my master will always do what needs to be done. Im not even sure how peacetime will agree with him.".to_owned(),
		...
		m.insert(
			"anakin_skywalker",
			vec![
				"Ive got a bad feeling about this.".to_owned(),
		...
		m.insert(
			...
			vec![
				...
				"Im terribly sorry about all this. After all, hes only a Wookiee!".to_owned(),
				"Dont you call me a mindless philosopher, you overweight glob of grease!".to_owned(),
				"Were doomed.".to_owned(),
				"I suggest a new strategy, R2. Let the Wookiee win.".to_owned(),
				"We seem to be made to suffer. Its our lot in life.".to_owned(),
				"Im backwards, you filthy furball!".to_owned(),
				"If I told you half the things Ive heard about this Jabba the Hutt, youd probably short circuit.".to_owned(),
				"Dont worry about Master Luke. Im sure hell be all right. Hes quite clever, you know… for a human being.".to_owned(),
				"I cant abide these Jawas. Disgusting creatures.".to_owned(),
				"Its against my programming to impersonate a deity.".to_owned(),
				"Just you reconsider playing that message for him! No, I dont think he likes you at all. No, I dont like you either.".to_owned(),
				"Now dont you forget this! Why I should stick my neck out for you is far beyond my capacity!".to_owned()
			],
		);
		...
		m.insert(
			...
			vec![
				...
				"Your swords, please. We dont want to make a mess of things in front of the Chancellor.".to_owned(),
		...
		m.insert(
			"darth_caedus",
			vec![
				"Youre smarter than a tree, arent you?".to_owned(),
				"Possessions are burdens. What you have can always be taken away, so wealth breeds fear.".to_owned(),
				"I just feel—I dont know. I hated it. I wanted it out of me. I wanted it dead—but, you know, while it was in me…it made me part of something. Like in the Nursery. During the fight, it was almost like having the Force again. Now—".to_owned()
			],
		);
		...
		m.insert(
			...
			vec![
				...
				"I am altering the deal. Pray I dont alter it any further.".to_owned(),
				"Perhaps you think youre being treated unfairly?".to_owned(),
		...
		m.insert(
			...
			vec![
				...
				"Oh, Im afraid the deflector shield will be quite operational when your friends arrive.".to_owned(),
		...
		m.insert(
			...
			vec![
				...
				"Im a big deal in the Resistance. Which puts a real target on my back.".to_owned(),
			],
		);
		...
		m.insert(
			"general_hux",
			vec![
				"I wont have you question my methods.".to_owned(),
		...
		m.insert(
			...
			vec![
				...
				"Soong peetch alay. (Its too late.)".to_owned(),
				...
				"Chosky nowy u chusu. (Im lucky I found you first.)".to_owned(),
				...
				"Ches ko ba tuta creesta crenko ya kolska! (This is something Ive been looking forward to for a long time.)".to_owned()
			],
		);
		...
		m.insert(
			"han_solo",
			vec![
				"Its the ship that made the Kessel Run in less than 12 parsecs.".to_owned(),
				...
				"I have a bad feeling about this.".to_owned(),
				"Bounty hunters! We dont need this scum.".to_owned(),
		...
		m.insert(
			...
			vec![
				...
				"Han, ma bookie, baldo nee anna dodo da eena. (Youre the best.)".to_owned(),
				...
				"Eek bon chee ko pa na green. (Ill put a price on your head so big...)".to_owned(),
				"na meeto do buny dunko la cho ya. (you wont be able to get near a civilized system.)".to_owned(),
		...
		m.insert(
			...
			vec![
				...
				"There you are. Im standing by as you requested, although theres a problem on the horizon. Theres no horizon.".to_owned()
		...
		m.insert(
			...
			vec![
				...
				"But how could they be jamming us if they dont know that were coming?".to_owned(),
		...
		m.insert(
			...
			vec![
				...
				"Help me Obi-Wan Kenobi. Youre my only hope.".to_owned(),
		...
		m.insert(
			...
			vec![
				...
				"Its not impossible. I used to bullseye womp rats in my T-16 back home; theyre not much bigger than two meters.".to_owned(),
				"You know, that little droid is going to cause me a lot of trouble.".to_owned(),
				"If youre saying that coming here was a bad idea, Im starting to agree with you.".to_owned(),
				"Youll find Im full of surprises!".to_owned(),
				"Your overconfidence is your weakness.".to_owned(),
				"You serve your master well. And you will be rewarded.".to_owned(),
				"Threepio, tell them if they dont do as you wish, youll become angry and use your magic.".to_owned(),
		...
		m.insert(
			...
			vec![
				...
				"You dont need to see his identification. These arent the droids youre looking for.".to_owned(),
				...
				"Thats no moon. Its a space station.".to_owned(),
		...
		m.insert(
			...
			vec![
				...
				"Ani? My goodness, youve grown.".to_owned(),
				"Anakin, youre breaking my heart. Youre going down a path I cant follow.".to_owned(),
		...
		m.insert(
			...
			vec![
				"You cant stop change any more than you can stop the suns from setting."
					.to_owned(),
				"The Republic doesnt exist out here. We must survive on our own.".to_owned(),
			],
		);
