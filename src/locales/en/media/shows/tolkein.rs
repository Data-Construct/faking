...
static POEMS: [&'static str; 74] = [
  ...
  "I sang of leaves, of leaves of gold (Galadriels Song of Eldamar)",
...
static POEMS_LEN: usize = POEMS.len();

static LOCATIONS: [&'static str; 1212] = [
  "Abyss",
  "Achad Tarlang",
  "Adorn",
  "Adurant",
...
static RACES_LEN: usize = RACES.len();

static CHARACTERS: [&'static str; 845] = [
  "Adalbert Bolger",
  "Adaldrida Bolger",
  "Adalgar Bolger",
  "Adalgrim Took",
