...
static QUOTES: [&'static str; 19] = [
    ...
    "I am not normally a praying man, but if you are up there, please save me, Superman!",
    "Doh!",
    "Thats it! You people have stood in my way long enough. I am going to clown college!",
...
static EPISODE_TITLES: [&'static str; 666] = [
	...
	"Bart the Genius",
	"Homers Odyssey",
	"There is No Disgrace Like Home",
	"Bart the General",
	"Moaning Lisa",
	...
	"So It is Come to This: A Simpsons Clip Show",
	"The Front",
	"Whacking Day",
	"Marge in Chains",
	...
	"Pray Anything",
	"Barting Over",
	"I am Spelling as Fast as I Can",
	...
	"Future-Drama",
	"Do not Fear the Roofer",
	"The Heartbroke Kid",
	"A Star Is Torn",
	"Thank God It is Doomsday",
	...
	"Midnight Towboy",
	"I Do not Wanna Know Why the Caged Bird Sings",
	...
	"The War of Art",
	"You Do not Have to Live Like a Referee",
	"Luca$",
	...
	"Girls in the Band",
	"I am Just a Girl Who Cant Say Doh",
	"Doh Canada",
	"Woo-Hoo Dunnit?",
