...
static QUOTES: [&'static str; 50] = [
  ...
  "First divorce: wifes hidden sexuality, not my fault. Second divorce: said the wrong name at the altar, kind of my fault. Third divorce: they shouldnt let you get married when you are that drunk and have stuff drawn all over your face, Nevadas fault.",
  ...
  "I am not someone who goes after a guy five minutes after hes divorced.",
  "We were on a break!",
