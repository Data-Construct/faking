...
static QUOTES: [&'static str; 50] = [
  ...
  "Guys can fake it? Unbelievable! The one thing that is ours!",
  "If you are going to call me names, I would prefer Ross, the Divorce Force. It is just cooler.",
  "All right, look if you absolutely have to tell her the truth, at least wait until the timings right. And that is what deathbeds are for.",
  "Your teeth? Yeah, I saw them from outside.",
  "Dear God! This parachute is a knapsack!",
  "No, homo habilis was erect. Australopithecus was never fully erect.",
  "Well, maybe he was nervous.",
  "I am glad were having a rehearsal dinner. I rarely practice my meals before I eat.",
  ...
  "You know whats weird? Donald Duck never wore pants. But whenever he is getting out of the shower, he always puts a towel around his waist. I mean, what is that about?",
  "Ross, just for my own peace of mind, you are not married to any more of us are you?",
  "It is a moo point. It is like a cows opinion; it does not matter. It is moo.",
  "First divorce: wifes hidden sexuality, not my fault. Second divorce: said the wrong name at the altar, kind of my fault. Third divorce: they should not let you get married when you are that drunk and have stuff drawn all over your face, Nevadas fault.",
  "It hurts my Joeys apple!",
  "Oh, are you setting Ross up with someone? Does she have a wedding dress?",
  "Your collective dating record reads like a who is who of human crap.",
  "If you do not help me cook I am going to take a bunch of those hot dogs and make a new appetiser called pigs in Ross.",
  ...
  "I can not believe my Dad saw us having sex! He did not make it to one of my piano recitals, but this he sees!",
  ...
  "You can not have S-E-X when your taking care of the B-A-B-I-E.",
  ...
  "I am not someone who goes after a guy five minutes after he is divorced.",
  "We were on a break!",
  "Oh, my God! If you say that one more time, I am going to break up with you!",
  "How you doin?",
  "Forty-two to twenty-one! Like the turkey, Ross is done!",
  "SEVEN! SEVEN! SEVEN!",
  "I am Monica. I am disgusting. I stalk guys and keep their underpants.",
  ...
  "Sure I peed on her. And if I had to, I would pee on any one of you!",
  "If the homo sapiens were, in fact, HOMO sapiens…is that why they are extinct?",
  ...
  "Oh no, two women love me. They are both gorgeous and sexy. My wallets too small for my fifties AND MY DIAMOND SHOES ARE TOO TIGHT."
];
