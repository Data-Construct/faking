...
#[wasm_bindgen(js_name = music_song_name)]
pub fn song_name() -> String {
	EN_SONG_NAME[seeder::gen_range(0..EN_SONG_NAME_LEN)].to_string()
}

static EN_SONG_NAME: [&'static str; 983] = [
  "White Christmas",
  "Hey Jude",
  ...
  "Sweet Soul Music",
  "Hey There Delilah",
  "A Whole New World (Aladdins Theme)",
  "Somethin Stupid",
  "Knock Three Times",
  "Mickey",
  "The Wanderer",
  ...
  "Private Eyes",
  "Maniac",
  "All My Lovin (You are Never Gonna Get It)",
  "Take a Bow",
  "Ring of Fire",
  ...
  "Baker Street",
  "Dardanella",
  "You Do not Have to Be a Star (To Be in My Show)",
  "Leaving",
  "Glory of Love",
...
static EN_SONG_NAME_LEN: usize = EN_SONG_NAME.len();