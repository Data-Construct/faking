...
pub fn male_prefix() -> String {
	MALE_PREFIX[seeder::gen_range(0..MALE_PREFIX_LEN)].to_string()
}

#[wasm_bindgen]
pub fn female_prefix() -> String {
	FEMALE_PREFIX[seeder::gen_range(0..FEMALE_PREFIX_LEN)].to_string()
}

#[wasm_bindgen]
pub fn neutral_prefix() -> String {
	NEUTRAL_PREFIX[seeder::gen_range(0..NEUTRAL_PREFIX_LEN)].to_string()
}

#[wasm_bindgen]
pub fn suffix() -> String {
	SUFFIX[seeder::gen_range(0..SUFFIX_LEN)].to_string()
}

#[wasm_bindgen]
pub fn male_first_name() -> String {
	MALE_FIRST_NAME[seeder::gen_range(0..MALE_FIRST_NAME_LEN)].to_string()
}

#[wasm_bindgen]
pub fn female_first_name() -> String {
	FEMALE_FIRST_NAME[seeder::gen_range(0..FEMALE_FIRST_NAME_LEN)].to_string()
}

#[wasm_bindgen]
pub fn neutral_first_name() -> String {
	NEUTRAL_FIRST_NAME[seeder::gen_range(0..NEUTRAL_FIRST_NAME_LEN)].to_string()
}
...
pub static MALE_PREFIX_LEN: usize = MALE_PREFIX.len();

pub static FEMALE_PREFIX: [&'static str; 3] = [
	"Mrs.",
	"Ms.",
	"Miss.",
];
pub static FEMALE_PREFIX_LEN: usize = FEMALE_PREFIX.len();

pub static NEUTRAL_PREFIX: [&'static str; 9] = [
	"Dr.",
	"Gov.",
	"Rep.",
	"Prof.",
...
pub static NEUTRAL_PREFIX_LEN: usize = FEMALE_PREFIX.len();

pub static SUFFIX: [&'static str; 19] = [
	"Jr.",
	"Sr.",
	"I",
	"II",
...
pub static SUFFIX_LEN: usize = SUFFIX.len();

pub static MALE_FIRST_NAME: [&'static str; 1219] = [
	"Aaron",
	"Abdul",
	"Abe",
	"Abel",
...
pub static MALE_FIRST_NAME_LEN: usize = MALE_FIRST_NAME.len();

pub static FEMALE_FIRST_NAME: [&'static str; 4271] = [
	"Abbey",
	"Abbie",
	"Abby",
	"Abigail",
...
pub static FEMALE_FIRST_NAME_LEN: usize = FEMALE_FIRST_NAME.len();

pub static NEUTRAL_FIRST_NAME: [&'static str; 65] = [
	"Alexis",
	"Ari",
	"Armani",
	"Avery",
...
pub static NEUTRAL_FIRST_NAME_LEN: usize = NEUTRAL_FIRST_NAME.len();

pub static LAST_NAME: [&'static str; 472] = [
	"Abbott",
	"Abernathy",
	"Abshire",
	"Adams",
...
pub static LAST_NAME_LEN: usize = LAST_NAME.len();
