...
static USERNAME_ADJECTIVES: [&'static str; 1347] = [
	"abandoned",
	"able",
	"absolute",
	"adorable",
...
static USERNAME_ADJECTIVES_LEN: usize = USERNAME_ADJECTIVES.len();

static USERNAME_PROPER_NAMES: [&'static str; 1323] = [
	"Aaron",
	"Adam",
	"Adlai",
	"Adrian",
...
static USERNAME_PROPER_NAMES_LEN: usize = USERNAME_PROPER_NAMES.len();

static USERNAME_WORDS: [&'static str; 25486] = [
	"a",
	"AAA",
	"AAAS",
	"aardvark",
...
static USERNAME_WORDS_LEN: usize = USERNAME_WORDS.len();
