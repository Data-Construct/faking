...
static MOVIE_QUOTES: [&'static str; 151] = [
	...
	"You have got to ask yourself one question: Do I feel lucky? Well, do ya, punk? - Dirty Harry, 1971",
	...
	"You have got red on you. - Shaun of the Dead, 2004",
	...
	"I am scared to close my eyes, I am scared to open them...We are gonna die out here. - The Blair Witch Project, 1999",
...
static MOTIVATIONAL_QUOTES: [&'static str; 344] = [
	...
	"You have gotta dance like there is nobody watching, love like youll never be hurt, sing like there is nobody listening, and live like its heaven on earth. -William W. Purkey",
	...
	"Would you like me to give you a formula for success? It is quite simple, really: Double your rate of failure. You are thinking of failure as the enemy of success. But it is not at all. You can be discouraged by failure or you can learn from it, so go ahead and make mistakes. Make all you can. Because remember, that is where you will find success. - Thomas J. Watson",
	...
	"You could rattle the stars, she whispered. You could do anything, if only you dared. And deep down, you know it, too. That is what scares you most. - Sarah J. Maas",
